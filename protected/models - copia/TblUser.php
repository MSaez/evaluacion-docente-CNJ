 ...
 * @property string $ev_paterno
 * @property string $ev_materno
 */
class TblUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, password, ev_nombres, ev_paterno, ev_materno', 'required'),
			array('username', 'length', 'max'=>12),
			array('password', 'length', 'max'=>50),
			array('username', 'validateRut'),
			array('ev_nombres, ev_paterno, ev_materno', 'length', 'max'=>256),
	...
	public function attributeLabels()
	{
		return array(
			...
			'password' => 'Contraseña',
			'ev_nombres' => 'Nombres',
			'ev_paterno' => 'Apellido Paterno',
			'ev_materno' => 'Apellido Materno',
		);
	}
