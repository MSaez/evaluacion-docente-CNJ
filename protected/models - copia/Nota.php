...
class Nota extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('a1i1, a1i2, a1i3, a1i4, a1i5, a1i6, a1i7, a2i1, a2i2, a2i3, a2i4, a2i5, a2i6, a2i7, a2i8, a2i9, a2i10, a2i11, a3i1, a3i2, a3i3, a3i4, a3i5, a3i6, a3i7, a3i8, a3i9, a3i10, fecha_ev, pro_evaluador, total_ambito1, total_ambito2, total_ambito3, total_logros, porcentaje_logro', 'required'),
			array('a1i1, a1i2, a1i3, a1i4, a1i5, a1i6, a1i7, a2i1, a2i2, a2i3, a2i4, a2i5, a2i6, a2i7, a2i8, a2i9, a2i10, a2i11, a3i1, a3i2, a3i3, a3i4, a3i5, a3i6, a3i7, a3i8, a3i9, a3i10, pro_evaluador, total_ambito1, total_ambito2, total_ambito3, total_logros, porcentaje_logro', 'numerical', 'integerOnly'=>true),
			...
			array('obs01, obs02, obs03, obs04, obs05, obs06, obs07, obs08, obs09, obs10, obs11, obs12, obs13, obs14, obs15, obs16, obs17, obs18, obs19, obs20, obs21, obs22, obs23, obs24, obs25, obs26, obs27,obs28', 'length', 'max'=>1024),
			array('observacion','numerical','min'=>0),
			array('observacion','numerical','max'=>5),
			array('clasificacion', 'length', 'max'=>16),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, a1i1, a1i2, a1i3, a1i4, a1i5, a1i6, a1i7, a2i1, a2i2, a2i3, a2i4, a2i5, a2i6, a2i7, a2i8, a2i9, a2i10, a2i11, a3i1, a3i2, a3i3, a3i4, a3i5, a3i6, a3i7, a3i8, a3i9, a3i10, fecha_ev, im_id, pro_evaluador, total_ambito1, total_ambito2, total_ambito3, total_logros, porcentaje_logro, observacion, clasificacion', 'safe', 'on'=>'search'),
		);
	}
