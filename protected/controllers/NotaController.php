		...
		if(isset($_POST['RetroalimentacionForm'])){
			...
			|| $model1 -> a1_mejorar == null || $model1 ->  a2_mejorar == null || $model1 ->  a3_mejorar == null){
					...
					$html="
						...
						<table align='center'>
							<tr>
								<td><img width=87 height=85 src='images/cnj_logo.png' align=left hspace=12> </td>
								<td><center><span>RETROALIMENTACIÓN OBSERVACIÓN DE AULA</span></b></p>
						            <p class=MsoNormal align=center style='text-autospace:none'><b><span>".$fecha."</span></b></p></center></td>
							</tr>
						</table>
						</center>
						...
						<table align='center' class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width=643
